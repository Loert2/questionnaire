...
INSERT INTO ticket (number_of_question) VALUES (11),(11),(11);

INSERT INTO question (id_ticket, name) VALUES
(1, "На какие электроустановки распространяются 'правила технической эксплуатации электроустановок потребителей'?"),
(1, "В каком случае электротехнический персонал обязан пройти производственное обучение на рабочем месте?"),
(1, "При каком повышении давления в баке трансформатора с устройствами газовой защиты нагрузка должна быть снижена?"),
(1, "При какой глубине раскопки грунта зимой должны производиться с отогревом грунта?"),
(1, "Как часто необходимо проверять исправность заземления арматуры ВЛ напряжением до 1000 В?"),
(1, "Какова периодичность осмотра аккумуляторных батарей дежурным персоналом?"),
(1, "Какую группу по электробезопасности должны иметь работники из числа оперативного персонала, единолично обслуживающие электроустановки напряжением выше 1000 В?"),
(1, "Можно ли работать в спецодежде с короткими или засученными рукавами в электроустановках напряжением до 1000 В при работе под напряжением?"),
(1, "Какую группу по электробезопасности должен иметь допускающий к производству работ в электроустановках напряжением до 1 КВ?"),
(1, "Обязан ли производитель работ (наблюдающий) удалить бригаду с места работы при необходимости временного ухода с рабочего места?"),
(1, "Что делать, если у пострадавшего нет сознания и нет пульса на сонной артерии?"),

(2, "На какие электроустановки не распространяются 'правила технической эксплуатации электроустановок потребителей'?"),
(2, "В каком случае электротехнический персонал обязан пройти производственное обучение на рабочем месте?"),
(2, "В каком режиме должны работать нейтрали обмоток 110 кв трансформаторов и реакторов?"),
(2, "Каково должно быть расстояние от поверхности отогреваемого слоя грунта до кабелей при раскопках зимой?"),
(2, "Какие помещения относятся к особо опасным (в отношении опасности поражения людей электрическим током)?"),
(2, "Должны ли быть доступны для осмотра соединения проводов?"),
(2, "Какую группу по электробезопасности должны иметь работники из числа оперативного персонала в электроустановках напряжением до 1000 В?"),
(2, "Какие меры предосторожности необходимы при работе под напряжением в электроустановках напряжением до 1000 В?"),
(2, "Должен ли назначаться ответственный руководитель работ в электроустановках напряжением выше 1000 В?"),
(2, "В каком случае допускается временный уход с рабочего места одного или нескольких членов бригады в электроустановках напряжением выше 1000 В?"),
(2, "Что необходимо сделать в первую очередь перед проведением реанимационных мероприятий?"),

(3, "На какие электроустановки не распространяются 'правила технической эксплуатации электроустановок потребителей'?"),
(3, "Какова продолжительность стажировки электротехнического персонала до назначения на самостоятельную работу?"),
(3, "Какое условие не допускает параллельной работы трансформаторов (автотрансформаторов)?"),
(3, "На каком расстоянии от кабеля применение при раскопках землеройных машины не допускается?"),
(3, "На кого возлагается ответственность за организацию и состояние охраны труда в службе ЭСТОП?"),
(3, "Можно ли устанавливать предохранители в нулевом рабочем проводе в сетях с заземленной нейтралью?"),
(3, "Какую группу по электробезопасности должны иметь старшие по смене или работники из числа персонала, единолично обслуживающие электроустановки напряжением выше 1000 В?"),
(3, "Какие организационные мероприятия обеспечивают безопасность работ в электроустановках?"),
(3, "На какой срок выдается наряд-допуск?"),
(3, "Какие действия обязан выполнить производитель работ при необходимости временного ухода с места работы в электроустановке?"),
(3, "Куда наносится удар, чтобы сердце заработало?")
